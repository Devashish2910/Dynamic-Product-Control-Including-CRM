<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true" CodeFile="FAQReturnandCancellationPolicy.aspx.cs" Inherits="FAQReturnandCancellationPolicy" %>
        ...
        <div class="row">            
            ...
            <div class="span9 post faqres">
                <h2 class="page-header">
                    <span>Return and Cancellation Policy</span></h2>
                <div class="sidebar-line">
                    <span></span>
                </div>
