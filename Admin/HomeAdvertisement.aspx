<%@ Page  Title="Best Admin" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="HomeAdvertisement.aspx.cs" Inherits="Admin_HomeAdvertisement" %>
                    ...
                    <td class="center">
                        ...
                        <asp:LinkButton ID="lnkbtnDelete" runat="server" CausesValidation="false" CommandArgument='<%# Bind("Id") %>'
                            ...
                            Text="Delete" Visible="false"></asp:LinkButton>
                             <a href="HomeAdvImageMap.aspx?id=<%# Eval("Id") %>">Image Map</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
