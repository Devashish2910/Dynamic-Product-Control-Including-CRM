<%@ Page  Title="Best Admin" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="SubCategoryImageMap.aspx.cs" Inherits="Admin_SubCategoryImageMap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="widget">
        ...
        <div class="rowElem noborder">
            <div class="formLeft">
                <asp:ImageMap ID="mapAreas" runat="server"
                    BorderStyle="Dotted" BorderColor="BlueViolet" BorderWidth="1px" CssClass="mapHiLight"
