...
public partial class Admin_AboutUs : System.Web.UI.Page
{
    ...
    protected void BindDescription()
    {
        ...
        ds = cls.ReturnDataSet("RetriveData_Alias",
            ...
            new SqlParameter("@TblNm", "AboutUs"),
           new SqlParameter("@WhereClause", "where AboutUs.IsActive = 1"));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            cls.ExecuteDA("Update_AboutUs", new SqlParameter("@ID", lblId.Text),
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "EditGroup")
        {
            ...
            ds = cls.ReturnDataSet("sp_RetriveDataWithField",
                ...
                new SqlParameter("@TblNm", "AboutUs"),
           new SqlParameter("@WhereClause", "AboutUs where Id ='" + e.CommandArgument + "' and AboutUs.IsActive = 1"));
