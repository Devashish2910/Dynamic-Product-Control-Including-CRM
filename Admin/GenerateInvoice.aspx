<%@ Page  Title="Best Admin" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="GenerateInvoice.aspx.cs" Inherits="Admin_GenerateInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="widget">
        <div class="head">
            <h5 class="iList">
                <div class="floatleft" style="width: 800px;">Order Details</div>
        ...
        <div class="rowElem ">
            ...
            <div class="floatleft33">
              ...
              <div class="floatleft33">
                ...
                <div class="margin5">
                  <asp:TextBox ID="txtDate" runat="server" CssClass="datepicker required"
                ...
                <div class="margin5">
                    <asp:DropDownList runat="server" ID="drpStatus" CssClass="required">
                        <asp:ListItem Text="Payment Pending Authorization"></asp:ListItem>
                        ...
                        <asp:ListItem Text="Part Order Shipped"></asp:ListItem>
    ...
    <div class="widget">
        <div class="head">
            <h5 class="iList">Invoice Generated for Products</h5>
        </div>
    ...
    <div class="widget">
        <div class="head">
            <h5 class="iList">Pending Products</h5>
        </div>
                ...
                <div class="rowElem ">
                    <div class="floatleft50">
                        ...
                        <div class="margin5">
                            ...
                            <asp:Label runat="server" ID="lblTotal" Text=' <%# Math.Round(Convert.ToDouble(Eval("FinalSellingPrice"))) * Convert.ToDouble(Eval("Quantity")) %> ' Visible="false"></asp:Label>
                        </div>
                    </div>
                    <div class="floatleft50">
                        <label class="width100px">
    ...
    <div class="widget">
        <div class="head">
            <h5 class="iList">Tracking Details</h5>
        </div>
        <div class="rowElem ">
            <div class="floatleft50">
                <label class="width100px">
                ...
                <div class="margin5">
                    <asp:DropDownList runat="server" ID="drpCourier"></asp:DropDownList>
                </div>
            </div>
            <div class="floatleft50">
                <label class="width100px">
        ...
        <div class="rowElem">
            ...
            <div class="floatleft">
                <div class="margin5">
                    <asp:TextBox runat="server" ID="txtOtherDetails" Width="770px" TextMode="MultiLine" Height="100px"></asp:TextBox>
                    <div class="fix">
                    </div>
                </div>
            </div>
        ...
        <div class="submitForm" style="width: 100%; margin-top: 10px; margin-right: 0px;">
            <div style="float: right">
                <asp:Button ID="btnGenerate" runat="server" Text="Generate Invoice" CssClass="greyishBtn" OnClick="btnGenerate_Click" />
            </div>
