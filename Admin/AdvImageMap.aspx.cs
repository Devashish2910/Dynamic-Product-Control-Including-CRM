...
public partial class Admin_AdvImageMap : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                lblFormTitle.Text = "ImageMap for Advertisement";
    ...
    protected void BindAdvDetail(string id)
    {
        ...
        dt = cls.ReturnDataTable("Select_AdvDetailOnId", new SqlParameter("@id", id));
    ...
    {
        DataTable dt = new DataTable();
        dt = cls.ReturnDataTable("Select_AdvImageMap", new SqlParameter("@AdvId", scid));
    ...
    {
        DataTable dt = new DataTable();
        dt = cls.ReturnDataTable("Select_AdvImageMap", new SqlParameter("@AdvId", Request.QueryString["id"]));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (rdbOption.SelectedValue == "0")
        {
            ...
            {
                cls.ExecuteDA("Insert_AdvImagemap", new SqlParameter("@AdvId", Request.QueryString["id"]),
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            cls.ExecuteDA("DeleteRecord", new SqlParameter("@TblNm", "AdvImageMap"),
