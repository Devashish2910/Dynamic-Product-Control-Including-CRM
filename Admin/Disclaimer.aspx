<%@ Page  Title="Best Admin" Language="C#" ValidateRequest="false" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Disclaimer.aspx.cs" Inherits="Admin_Disclaimer" %>
    ...
    <div class="table">
        ...
        <asp:Repeater ID="rptr" runat="server" OnItemCommand="rptr_ItemCommand">
            ...
            <ItemTemplate>
                <tr class="gradeA">
                    <td>
                        <asp:Label ID="lblDisclaimerid" runat="server" Text='<%#Eval("Description")%>'></asp:Label>
                    </td>
                    <%-- <td>
