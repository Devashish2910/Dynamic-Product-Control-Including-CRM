...
public partial class Admin_GenerateInvoice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (Request.QueryString["ID"] != "" && Request.QueryString["ID"] != null)
            {
                ...
                lblFormTitle.Text = "Generate Invoice";
    ...
    {
        dtprod = cls.ReturnDataTable("Select_GeneratedInvoiceProductFromOrderId", new SqlParameter("@InvoiceId", invoiceid));
    ...
    protected void GenerateInvoiceNo()
    {
        ...
        dtinvoiceno = cls.ReturnDataTable("Select_MaxInvoiceNo", new SqlParameter("@InvoiceId", invoiceid));
        if (dtinvoiceno.Rows.Count > 0)
        {
            invno = dtinvoiceno.Rows[0]["InvoiceNumber"].ToString();
            invoiceno = "TSM" + orderno.ToString() + "-" + dtinvoiceno.Rows[0]["InvoiceNumber"].ToString();
        }
        lblInvoiceNo.Text = invoiceno;
        lblInvoiceNoMail.Text = "TSM_Invoice_" + orderno.ToString() + "-" + dtinvoiceno.Rows[0]["InvoiceNumber"].ToString();
    }
...
public partial class HeaderFooter1 : PdfPageEventHelper
{
    ...
    public HeaderFooter1(PdfPCell cell)
    {
        cellLeft = cell;
    }
