<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="HomeDescription.aspx.cs" Inherits="Admin_HomeDescription" %>
...
<link href="../Style/ftb.css" rel="stylesheet" type="text/css" />
    ...
    <div class="table">
        ...
        <asp:Repeater ID="rptr" runat="server" OnItemCommand="rptr_ItemCommand">
            <HeaderTemplate>
                <table cellpadding="0" cellspacing="0" border="0" id="Column0" class="display">
                    <thead>
                        <tr>
                            <th align="left">Home Description
                            </th>
            ...
            <ItemTemplate>
                <tr class="gradeA">
                    <td>
                        <asp:Label ID="lblHomeDescriptionid" runat="server" Text='<%#Eval("Description")%>'></asp:Label>
                    </td>
                    <%-- <td>
