...
public partial class Admin_PrivacyPolicy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //else
            {
                ...
                lblFormTitle.Text = "Privacy Policy";
                BindDescription();
            }
        }
    }
    ...
    protected void BindDescription()
    {
        ...
        ds = cls.ReturnDataSet("RetriveData_Alias",
            ...
            new SqlParameter("@TblNm", "PrivacyPolicy"),
           new SqlParameter("@WhereClause", "where PrivacyPolicy.IsActive = 1"));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            cls.ExecuteDA("Update_PrivacyPolicy", new SqlParameter("@ID", lblId.Text),
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "EditGroup")
        {
            ...
            ds = cls.ReturnDataSet("sp_RetriveDataWithField",
                ...
                new SqlParameter("@TblNm", "PrivacyPolicy"),
           new SqlParameter("@WhereClause", "PrivacyPolicy where Id ='" + e.CommandArgument + "' and PrivacyPolicy.IsActive = 1"));
