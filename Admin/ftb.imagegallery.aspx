...
<body>
    ...
    <form id="Form1" runat="server" enctype="multipart/form-data">  
		...
		<FTB:ImageGallery AllowImageDelete="true" 
		AllowImageUpload="true" AllowDirectoryCreate="true"  
		AllowDirectoryDelete="True" id="ImageGallery1" runat="Server" />
		 
		<%--<FTB:ImageGallery AllowImageDelete="true" AllowImageUpload="true" id="ImageGallery2"
