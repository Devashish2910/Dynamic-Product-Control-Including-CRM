<%@ Page  Title="Best Admin" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Brand.aspx.cs" Inherits="Admin_Brand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="widget">
        ...
        <div class="rowElem noborder">
            <label>
                Brand Name:<span class="req">*</span></label>
            <div class="formLeft">
                <asp:TextBox ID="txtbrandname" runat="server" CssClass="required" Width="200px"></asp:TextBox>
                <div class="fix">
                </div>
            </div>
        </div>
