...
public partial class Admin_TermsAndConditions : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //else
            {
                ...
                lblFormTitle.Text = "Terms And Conditions";
                BindDescription();
            }
        }
    }
    ...
    protected void BindDescription()
    {
        ...
        ds = cls.ReturnDataSet("RetriveData_Alias",
            ...
            new SqlParameter("@TblNm", "TermsNConditions"),
           new SqlParameter("@WhereClause", "where TermsNConditions.IsActive = 1"));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            cls.ExecuteDA("Update_TermsNConditions", new SqlParameter("@ID", lblId.Text),
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "EditGroup")
        {
            ...
            ds = cls.ReturnDataSet("sp_RetriveDataWithField",
                ...
                new SqlParameter("@TblNm", "TermsNConditions"),
           new SqlParameter("@WhereClause", "TermsNConditions where Id ='" + e.CommandArgument + "' and TermsNConditions.IsActive = 1"));
