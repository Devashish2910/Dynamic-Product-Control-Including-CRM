...
public partial class Admin_HomeAdvertisement : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //else
            {
                ...
                lblFormTitle.Text = "Manage Home Advertisement";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (fupPhoto.HasFile != false)
        {
            ...
            isoscalar = Math.Min((1130 / UploadedImageWidth), (145 / UploadedImageHeight));
        ...
        if (string.IsNullOrEmpty(lblId.Text))
        {
            ...
            lblMsg.Text = "You can insert new record please edit existance data.";
            return;
        }
        else
        {
            cls.ExecuteDA("Update_HomeAdd", 
                    new SqlParameter("@Id", lblId.Text),
                    new SqlParameter("@Image", strDoc),              
                    new SqlParameter("@IsActive", 1));

            //update in imagemap table
            cls.ExecuteDA("Update_ImageMapHomeAdv", new SqlParameter("@Id", lblId.Text), new SqlParameter("@url", strDoc));
                clearall();
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "EditGroup")
        {
            ...
            ds = cls.ReturnDataSet("sp_RetriveDataWithField",
                ...
                new SqlParameter("@TblNm", "HomeAdd"),
           new SqlParameter("@WhereClause", "where Id ='" + e.CommandArgument + "' and HomeAdd.IsActive = 1"));
