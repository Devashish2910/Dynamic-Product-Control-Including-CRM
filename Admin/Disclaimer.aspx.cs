...
public partial class Admin_Disclaimer : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            cls.ExecuteDA("Update_Disclaimer", new SqlParameter("@ID", lblId.Text),
    ...
    protected void rptr_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "EditGroup")
        {
            ...
            ds = cls.ReturnDataSet("sp_RetriveDataWithField",
                ...
                new SqlParameter("@TblNm", "Disclaimer"),
           new SqlParameter("@WhereClause", "Disclaimer where Id ='" + e.CommandArgument + "' and Disclaimer.IsActive = 1"));
