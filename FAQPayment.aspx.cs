...
public partial class FAQPayment : System.Web.UI.Page
{
    ...
    {
        DataSet ds = new DataSet();
        ds = cls.ReturnDataSet("sp_RetriveData", new SqlParameter("@TblNm", "FAQ"), new SqlParameter("@strWhereClause", "where CatId=3"));
